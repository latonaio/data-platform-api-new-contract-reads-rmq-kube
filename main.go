...
import (
	dpfm_api_caller "data-platform-api-new-contract-reads-rmq-kube/DPFM_API_Caller"
	...
	"data-platform-api-new-contract-reads-rmq-kube/config"
	"encoding/json"
	"fmt"
	"time"

	"github.com/latonaio/golang-logging-library-for-data-platform/logger"
	database "github.com/latonaio/golang-myasql-network-connector"
